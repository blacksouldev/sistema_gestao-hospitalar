...
class _NovoPacienteState extends State<NovoPaciente> {
  ...
  void initState() {
    ...
    if (widget.paciente != null) {
      ...
      _dataCadastro = widget.paciente!.dataCadastro;
    } else {
      _nome = '';
      _cpf = '';
      _telefone = '';
      _email = '';
      _dataCadastro = DateTime.now(); // dataCadastro nova para paciente novo
    }
  }
  ...
  Widget build(BuildContext context) {
    return Form(
      key: _formKey,
      child: SingleChildScrollView( // Para evitar overflow quando teclado abrir
        child: Column(
